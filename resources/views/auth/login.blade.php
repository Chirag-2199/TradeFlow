    ...
    <header class="bg-[#23297f] text-white py-4 px-6 shadow-xl">
        <div class="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <div class="flex items-center space-x-6">
                <a href="{{ route('login') }}" class="bg-white text-[#23297f] px-6 py-2 rounded-full font-semibold hover:bg-opacity-90 transition-all duration-300 shadow-lg">
                    Get Started
                </a>
            </div>
        </div>
    ...
    <section class="bg-gradient-to-b from-[#23297f] to-white pt-24 pb-32 min-h-screen">
        <div class="max-w-md mx-auto px-4">
            <div class="bg-white rounded-2xl shadow-xl px-8 py-10">
                <h2 class="text-3xl font-bold text-[#23297f] text-center mb-8">Welcome Back</h2>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember" class="rounded border-gray-300 text-[#23297f] focus:ring-[#23297f]">
                            <span class="ml-2 text-sm text-gray-600">Remember me</span>
                        </label>
                        <a href="#" class="text-sm text-[#23297f] hover:underline">Forgot password?</a>
                    </div>
                ...
                <p class="mt-8 text-center text-gray-600">
                    New to TradeFlow? 
                    <a href="{{ route('register') }}" class="text-[#23297f] font-semibold hover:underline">Create account</a>
                </p>
            </div>
        </div>
    </section>
